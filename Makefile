...
FEATURES += AETR
#FEATURES += ENABLE_PPM
#FEATURES += ENABLE_USART
#FEATURES += ENABLE_SERIAL_FIFOS
#FEATURES += FIFO_SIZE=1024
#FEATURES += ENABLE_VCOM
#FEATURES += ENABLE_DEBUG
#FEATURES += ENABLE_CLI
#FEATURES += CONSOLE_PRINT_MAX_LEN=256
...
CPPFLAGS = $(MCU) $(addprefix -D, $(C_DEFS)) $(addprefix -I, $(C_INCLUDES)) $(OPT) -Wall -fdata-sections -ffunction-sections
